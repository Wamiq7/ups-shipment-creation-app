    ...
    <nav className="bg-blue-400 border-gray-200">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg items-center md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0">
            {!isToken ? (
              <button
                className="block bg-white py-2 px-3 text-blue-400  rounded-full md:px-3 md:py-1"
                onClick={getToken}
              >
                Authenticate
              </button>
